...
const BookingForm: React.FC = () => {
  ...
  const fullyBookedDates = [new Date(2026, 2, 28), new Date(2026, 3, 1)];
      ...
      <div className="w-full md:w-[60%] px-8 py-10 lg:px-[60px] flex flex-col justify-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="relative">
            <MessageSquare
              size={18}
              className="absolute left-[14px] top-[15px] text-black z-10"
            />
            <textarea
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mt-2">
            <div className="flex items-start gap-3">
              <AlertCircle
                size={20}
                className="text-[#ff7043] shrink-0 mt-0.5"
              />
              <div>
                <h4 className="text-[13px] font-bold text-orange-900 uppercase">
                  Cancellation Policy
                </h4>
                <p className="text-[12px] text-orange-800 leading-relaxed">
                  Cancellations must be made at least **2 days** before your
                  scheduled time. Late cancellations may affect future bookings.
                </p>
              </div>
            </div>
