...
const Home: React.FC = () => {
  ...
  return (
    <div ref={scrollRef} className="flex flex-col min-h-screen w-full bg-white font-sans overflow-x-hidden">

      {/* 1. HERO SECTION */}
      <header 
        className="h-[530px] w-full flex items-center justify-center bg-cover bg-center relative"
        style={{ 
